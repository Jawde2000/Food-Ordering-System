...
public class Menu {
    ...
    public static void load_menu(String opt) throws FileNotFoundException {
        ...
        try {
            ...
            if ((opt.equals("1") || opt.equals("2") || opt.equals("3") || opt.equals("4"))) {
                System.out.println(deco.repeat(95));
                System.out.format(
                        "%-11s %-15s %-13s %-11s %-25s %-11s"
                        , "FoodID", "Food Name", "Status", "Size",
                        "Permit Status", "Price(RM)");
                System.out.println();
                System.out.println(tab.repeat(19) + "Large Medium Small");
                System.out.println(deco.repeat(95));
            }
